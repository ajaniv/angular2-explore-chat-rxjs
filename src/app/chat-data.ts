...
const me: User = new User( 'Juliet', require( 'assets/images/avatars/female-avatar-1.png' ) );
const ladycap: User = new User( 'Lady Capulet', require( 'assets/images/avatars/female-avatar-2.png' ) );
const echo: User = new User( 'Echo Bot', require( 'assets/images/avatars/male-avatar-1.png' ) );
const rev: User = new User( 'Reverse Bot', require( 'assets/images/avatars/female-avatar-4.png' ) );
const wait: User = new User( 'Waiting Bot', require( 'assets/images/avatars/male-avatar-2.png' ) );
